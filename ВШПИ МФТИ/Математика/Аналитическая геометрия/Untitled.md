...
Возможны следующие случаи:
**1 cлучай**: $\Delta > 0$
Тогда $A'C' >0 \implies A,C$ одного знака
...
$M > 0$ – элипс
$M < 0$ – мнимый эллипс
$M = 0$ – пара мнимых пересекающихся прямых

**2 случай**: $\Delta < 0$
Тогда $A'C' < 0 \implies A,C$ – разных знаков 

Аналогично выделяем полные квадраты и получаем:
$A'x'' + C'y'' = M$
$M \neq 0$ – гипербола 
$M = 0$ – пара пересекающихся прямых

**3 случай:** $\Delta = 0$
В этом случае или $A' = 0$, или $C' = 0$. Без ограничения общности $C' =0$:
$A'x'^2 + 2D'x' + 2E'y' + F' = 0$

*Подслучай 1*:  $E'\neq 0$
Выделяем полный квадрат по $x'$:
$A'\left( x' + \frac{D'}{A'} \right)^2 + 2E'y' = \frac{D'^2}{A'} - F'$

Вводим $x'' = x' + \frac{D'}{A'}, y''=y'$ и получаем:
$A'x''^2 + 2E'y'' = K$, где $K =\frac{D'^2}{A'}-F'$
Это парабола

*Подслучай 2:* $E' = 0$
Тогда уравнение имеет вид: $A'x'^2+2D'x'+F'=0$
Это квадратное уравнение относительно $x'$

Если имеет 2 различных действительных корня $\to$ пара параллельных прямых
Если имеет 2 различных мнимых корня $\to$ пара мнимых параллельных прямых
Если имеет один корень $\to$ пара совпавших прямых