...
- $\bar{a}, \bar{b}$ - коллинеарны (*$\implies \bar{a},\bar{b},\bar{c}$ - компланарны*) $\implies$ верно, $V_{\pm}=0 \ ([\bar{a}, \bar{b}] = 0)$
- $\bar{a}, \bar{b}$ - неколлинеарны $\implies$ $([\bar{a}, \bar{b}], \bar{c}) = |[\bar{a}, \bar{b}]| * Пр_{[\bar{a}, \bar{b}]}\bar{c}$, где $|[\bar{a}, \bar{b}]| = S_{параллелограмма}$, $|Пр_{[\bar{a}, \bar{b}]} \bar{c}| = h_{параллелепипеда} \implies ([\bar{a}, \bar{b}], \bar{c}) = V_\pm$
- $\bar{a}, \bar{b}, \bar{c}$ - некомпланарны $\implies$ $+V$, если правая тройка; $-V$, если левая (т.к. $\bar{a}, \bar{b},  [\bar{a},\bar{b}]$ - правая тройка, а $\bar{a}, \bar{b}, \bar{c}$ - левая, то знак проекции будет отрицательным $\implies$ $(\bar{a}, \bar{b}, \bar{c}) = ([\bar{a}, \bar{b}], \bar{c}) = V_{\pm} < 0$)
