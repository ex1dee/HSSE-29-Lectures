...
5. $\ \forall \bar{a}, \bar{b}, \bar{c}: [\bar{a} \pm \bar{b}, \bar{c}] = [\bar{a}, \bar{c}] \pm [\bar{b}, \bar{c}]$
...
Но формула, верная в одном базисе, верна в любом базисе
...
$$
\begin{array}{}
S^2 = |[\bar{a}, \bar{b}]|^2 = |\bar{a}|^2|\bar{b}|^2\sin^2\alpha = |\bar{a}|^2|\bar{b}|^2 (1-\cos^2\alpha) = \\
