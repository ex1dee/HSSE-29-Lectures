...
>**Направление** — класс всех векторов, отличающихся только положительных скалярным множителем. Обозначается как $(\alpha, \beta) \neq (0, 0)$
...
*2 подслучай:* $\beta = 0$
Тогда $P$ тождественно равно $0 \implies$ подходят все $\alpha$ – это направление $(1, 0)$
